 ...
 * antiga só sem ele. usd() é sempre 2 casas.
 *
 * V6.10 (spec genesis-v6-10-implementacao, item 2.3.3): cifrão passou de "$ " (com espaço) para
 * "$" colado — mesmo padrão em toda a tela, "$69,155.8".
 */
