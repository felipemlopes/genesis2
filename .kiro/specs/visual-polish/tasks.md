...
- [ ] 1. Implementar efeito Shimmer reutilizável (CSS global)
  - [ ] 1.1 Adicionar keyframes e classes shimmer no `index.html`
...
- [ ] 2. Implementar Background Animado 3D e Hero na LandingPage
  - [ ] 2.1 Substituir background estático por orbs `motion.div` com animação 3D
  ...
  - [ ] 2.2 Implementar Hero Section com motion.div e texto gradiente
...
- [ ] 3. Implementar Header Pill e Cards de Filosofia na LandingPage
  - [ ] 3.1 Refatorar header para container pill com glassmorphism
  ...
  - [ ] 3.2 Implementar cards de filosofia com stagger e neon glow
...
- [ ] 5. Criar componente VersionSelector
  - [ ] 5.1 Criar `components/VersionSelector.tsx` com interface e estrutura base
  ...
  - [ ] 5.2 Implementar cards de versão com efeitos visuais
    ...
    - Callback `onSelectVersion?.(version)` com optional chaining
...
- [ ] 6. Modificar AlertaPopup (RadarNewsPopup) com countdown e glow direcional
  - [ ] 6.1 Ajustar estilos e barra de progresso no `RadarNewsPopup.tsx`
  ...
  - [ ] 6.2 Implementar glow direcional por market_bias
...
- [ ] 7. Ajustes no GeopoliticalRadar (RadarNews)
  - [ ] 7.1 Adicionar glow no pill de status do `GeopoliticalRadar.tsx`
...
- [ ] 8. Implementar labels responsivos na Sidebar
  - [ ] 8.1 Aplicar classes responsivas nos labels do `Sidebar.tsx`
...
- [ ] 9. Implementar stagger animations globais nos cards do app
  - [ ] 9.1 Aplicar motion wrapper com stagger nos dashboards
